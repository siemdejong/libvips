#!/bin/bash
# Test script for OME-Zarr functionality

cd build

echo "=== Testing zarrsave with OME-Zarr support ==="
echo ""
...
# Test 2: OME-Zarr Zarr (3-band)
echo ""
echo "Test 2: OME-Zarr Zarr (3-band RGB)"
rm -rf test_ome_rgb.zarr
./tools/vips copy test_white.v test_ome_rgb.zarr[ome_zarr]
...
# Test 3: OME-Zarr Zarr (1-band)
echo ""
echo "Test 3: OME-Zarr Zarr (1-band grayscale)"
rm -rf test_ome_grey.zarr
./tools/vips copy test_grey.v test_ome_grey.zarr[ome_zarr]
...
echo ""
echo "  OME-Zarr Zarr attributes (first 10 lines):"
cat test_ome_rgb.zarr/zarr.json | grep -A 10 '"attributes"'

echo ""
echo "=== All OME-Zarr tests complete ==="
echo ""
echo "Summary:"
echo "  - Regular Zarr: Array at root, no OME metadata"
echo "  - OME-Zarr: Array in /0/, full OME-Zarr v0.5 metadata"
